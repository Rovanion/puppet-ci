name    'soumentrivedi-puppetci'
version '0.0.1'
source 'https://github.com/soumentrivedi/puppet-ci'
...
project_page 'https://github.com/soumentrivedi/puppet-ci'

## Add dependencies, if any:
dependency 'rtyler/jenkins', '>= 1.3.0'
